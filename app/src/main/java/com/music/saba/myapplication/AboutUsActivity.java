...
//        simulateDayNight(/* DAY */ 0);
        ...
        View aboutPage = new AboutPage(this)
                .isRTL(true)
                .setImage(R.drawable.shellicon)
                .addItem(new Element().setTitle("نسخه 1"))
                .addGroup("با ما در ارتباط باشید")
                .addEmail("saba.zarean@gmail.com")
                .addWebsite("http://dimia.ir/")
                .addFacebook("www.facebook.com")
                .addTwitter("saba.zn74")
                .addInstagram("saba.zn74")
                .create();
